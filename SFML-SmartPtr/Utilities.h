...
/// <summary>
/// "Perfect forwarding"
/// Flexible et universelle
/// Fonctionne aussi bien pour les rvalues que pour les lvalues
/// Pas de copies mais déplacement, donc plus optimisé
/// </summary>
template <typename Type, typename... Args>
Shared<Type> MakeShared(Args&&... args) 
{
    return make_shared<Type>(forward<Args>(args)...);
}